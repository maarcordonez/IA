...
with open(f"problem roverPro2_{seedMapa}_{num}_{numRovers}.pddl", 'w') as f:
    sys.stdout = f # Change the standard output to the file we created.
    print(f"(define (problem roverPro22) (:domain roverTo22)")
    print("(:objects")
    ...
    print("(:metric maximize (combustible_total)))")